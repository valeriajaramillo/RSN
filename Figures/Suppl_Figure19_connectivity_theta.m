...
saveas(gcf,[Savefolder,'Figure5_lme_thetastim_PLV_',band_name{band1},'-',band_name{band2},'.svg'])

%     end

% end

% saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_condition_PLV_allbands.svg'])
...
% saveas(gcf,[Savefolder,'Figure5_ttest_',band_name{band1},'-',band_name{band2},'_',conditions{cond},'_cluster_theta_dots_PLV.svg']);
% close
end

% sgtitle([band_name{band},' theta PLV'])
% cd(figPath)

saveas(gcf,[Savefolder,'Figure5_ttest_',band_name{band1},'-',band_name{band2},'cluster_theta_dots_PLV.svg']);
...
saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_substage_PLV_allbands.svg'])

%% thetastim lme PLV - substage * condition
...
saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_substage_condition_PLV_allbands.svg'])


%% thetastim lme PLI - condition
...
% saveas(gcf,[Savefolder,'Figure5_lme_thetastim_PLI_',band_name{band1},'-',band_name{band2},'.svg'])

    end

end

saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_condition_PLI_allbands.svg'])
   
%% thetastim lme PLI - substage
...
saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_substage_PLI_allbands.svg'])

%% thetastim lme PLI - substage * condition
...
saveas(gcf,[Savefolder,'Suppl_Figure5_lme_thetastim_substage_condition_PLI_allbands.svg'])
