...
for band = 1:15
    ...
    batch(cluster,@cluster_analysis_power_theta,0,{Savefolder, band},'AutoAttachFiles', false, ...
...
function cluster_analysis_power_theta(Savefolder, band)
...
% for band = 1:15
    ...
    save([Savefolder,'statsresult_theta_',band_name{band},'.mat'],'statsresult');
