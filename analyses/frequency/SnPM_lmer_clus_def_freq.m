function statsresult = SnPM_lmer_clus_def_freq(u,table_allch,type,nch,neighbours)
...
%     allsub_table_substage(j,:) = table_el_perm_allsub.substage;
          ...
          lme = fitlme(table_el_perm_allsub,'freq_change ~ substage * condition +(1|sub)','FitMethod','REML','DummyVarCoding','effects');
...
%        table_el_perm.stroke = au';
        ...
        lme = fitlme(table_el,'freq_change ~ substage * condition +(1|sub)','FitMethod','REML','DummyVarCoding','effects');
